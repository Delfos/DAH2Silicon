...
public class A13HL72SiliconConverter extends AbstractHL7SiliconConverter {

	private static final Logger log = Logger.getLogger(A13HL72SiliconConverter.class);
	...
	public String convert(String msg) throws IllegalArgumentException{
		...
		try{
			transformers.get(A13_TRANSFORMER).transform(msgSource, result);
