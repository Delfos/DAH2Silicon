...
public class A40HL7SiliconConverter extends AbstractHL7SiliconConverter
		implements HL72SiliconConverter {

	private static final Logger log = Logger.getLogger(A40HL7SiliconConverter.class);
	...
	public String convert(String msg) throws IllegalArgumentException{
		...
		try{
			...
			Transformer xmlTrans = transformers.get(A40_TRANSFORMER);
