...
public abstract class AbstractFileTransformer implements FileTransformer {
	...
	protected static final String[] mshSpec = {"MSH-1", "MSH-2", "MSH-3-1", "MSH-3-2", "MSH-3-3",
	...
	protected static final String[] pidSpec = {"PID(0)-1", "PID(0)-2-1", "PID(0)-2-1", "PID(0)-2-2",
	...
	protected static final String[] pv1Spec = {
			"PV1-1",
			"PV1-2",
	...
	protected static final String[] evnSpec = {"EVN-1", "EVN-2-1", "EVN-2-2", "EVN-3-1", "EVN-3-2",
	...
	protected abstract void copyMSH(Terser src, Terser dest) throws DataTypeException, HL7Exception;
	
	protected abstract void copyEVN(Terser src, Terser dest) throws HL7Exception;
