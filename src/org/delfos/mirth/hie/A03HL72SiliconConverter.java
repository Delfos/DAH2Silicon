...
public class A03HL72SiliconConverter extends AbstractHL7SiliconConverter implements HL72SiliconConverter {

	private static final Logger log = Logger.getLogger(A03HL72SiliconConverter.class);
	...
	public String convert(String msg) throws IllegalArgumentException{
		...
		try{
			transformers.get(A03_TRANSFORMER).transform(msgSource, result);
