...
public class A02HL72SiliconConverter extends AbstractHL7SiliconConverter {

	private static final Logger log = Logger.getLogger(A02HL72SiliconConverter.class);
